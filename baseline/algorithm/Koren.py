...
from .algorithm_koren import (
    _compute_val_metrics,
    _initialization,
    _run_epoch,
    _compute_val_metrics_average,
    _compute_val_metrics_bubi_average,
)
...
class SVD_Koren:
    ...
    def _run_sgd(self, X, X_test):
        ...
        for epoch_ix in range(self.n_epochs):
            ...
            if self.algorithm == "koren_average":
            ...
            if self.algorithm == "koren_bubi_average":
                self.metrics_.loc[epoch_ix, :] = _compute_val_metrics_bubi_average(
                    X=X_test,
                    bu=bu,
                    bi=bi,
                    pu=pu,
