...
max_rating = 5
params = open(r"C:\Users\nvtru\Desktop\auto-recommender\resuld\movielens_edulive_nomod_params",'rb')
hyperparams = open(r"C:\Users\nvtru\Desktop\auto-recommender\resuld\movielens_edulive_nomod_hyperparams",'rb')
user_item_map = open(r"C:\Users\nvtru\Desktop\auto-recommender\resuld\movielens_edulive_nomod_params_user_item_map",'rb')
...
def update_param(pu, qi, pu_a,qi_a, user, item, rating,time_exam_mean,action_exam_mean, timestamps,time_exam,action_exam,tu,global_mean_,lambda1,lambda2, alpha,beta, mod, lr , reg, pen, std_ ):
    ...
    dbfile = open(r"C:\Users\nvtru\Desktop\auto-recommender\resuld\movielens_edulive_nomod_params", "wb")
